...
<head>
    ...
    <style>
        ...
        /* PARTY CARDS - Customer, Account, Rider */
        .party-section {
            width: 100%;
            margin: 0.3cm 0 0.5cm 0;
            border-collapse: collapse;
...
<body>
    ...
    <div class="receipt-wrapper">
        ...
        <!-- RECEIPT TYPE -->
        <table class="receipt-type-card" cellspacing="0">
            <tr>
                <td>
                    <span class="type-badge">{{ $record->amount < 0 ? 'REFUND / ADJUSTMENT' : 'RECEIPT' }}</span>
                    <span class="type-label">via {{ $record->paymentMethod->name ?? 'N/A' }}</span>
                </td>
            </tr>
        </table>

        <!-- Customer and Account Details Side by Side -->
            ...
            <tr>
                <td class="left-cell">
                    ...
                    <div class="party-detail">
                        ...
                        @if ($record->customer->city)
                        <br>
                            area: {!! $record->customer->area->name !!}
                        @endif
                    </div>
                ...
                <td class="right-cell">
                    ...
                    <div class="badge badge-account">deposit to</div>
                </td>
            </tr>
        </table>

        <!-- Rider and Outlet Details -->
        <table class="party-section" cellspacing="0">
            <tr>
                <td class="left-cell">
                    <div class="party-title">rider / collector</div>
                    <div class="party-detail">
                        @if ($record->rider)
                            <strong>{!! $record->rider->name !!}</strong><br>
                            @if ($record->rider->email)
                                email: {!! $record->rider->email !!}<br>
                            @endif
                            @if ($record->rider->phone)
                                tel: {!! $record->rider->phone !!}
                            @endif
                        @else
                            <em>Not assigned</em>
                        @endif
                    ...
                    @if ($record->rider)
                        <div class="badge badge-rider">collected by</div>
                    @endif
                </td>
                <td class="right-cell">
        ...
        <table class="amount-card" cellspacing="0">
            <tr>
                <td>
                    <span class="amount-label">receipt amount</span>
        ...
        <div class="footer-note clearfix">
            ...
            <div class="meta-box">
                <div class="receipt-stamp">RECEIPT VOUCHER</div>
        ...
        <div style="text-align:center; color:#869fac; font-size:7pt;">
            account ledger updated • customer ledger updated • receipt ref: {{ $record->receipt_number }}
        </div>
    ...
    <div style="margin-top:0.7cm; text-align:right; color:#92a9b9; font-size:8pt;">
        receipt voucher • this is a system generated document
    </div>
</body>
