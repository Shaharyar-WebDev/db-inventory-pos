...
<body>
    ...
    <div class="payment-wrapper">
        ...
        <!-- 3-Column Party Grid (Supplier | Account | Outlet) -->
                ...
                <td>
                    ...
                    <div class="party-detail">
                        ...
                        @if ($record->supplier->contact)
                            <br>Tel: {{ $record->supplier->contact }}
                        @endif
                        @if ($record->supplier->email)
                            <br>{{ $record->supplier->email }}
                        @endif
                    </div>
                </td>
        ...
        @if ($record->purchase)
            <table class="party-grid" cellspacing="0">
                <tr>
                    <td colspan="3" style="background: #f6f9fc; border: 0.8px solid #dde5ec; padding: 0.15cm;">
    ...
    <div class="payment-wrapper">
        ...
        <!-- Footer - Supplier Copy with Payment Stamp -->
        <div class="footer-note clearfix">
            <div class="footer-left"><span class="disclaimer-text">Computer generated</span></div>
            @if ($footerLogoPath)
                <div class="footer-center"><img style="max-height: 0.7cm;" src="{{ $footerLogoPath }}"
                        alt="Footer"></div>
            @endif
            <div class="footer-right"><span class="payment-stamp">Signature</span></div>
        </div>
    </div>
</body>
