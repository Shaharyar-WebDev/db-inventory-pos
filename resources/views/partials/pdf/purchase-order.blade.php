...
<head>
    ...
    <style>
        ...
        /* ULTRA COMPACT - 2 orders per page */
        body {
            margin: 0;
            padding: 0.2cm;
        ...
        /*-----------------------------------------------
            PARTY GRID - 2 Columns for Purchase
        -----------------------------------------------*/
        .party-grid {
            width: 100%;
...
<body>
    ...
    <!-- First Purchase Order - Office Copy -->
        ...
        <div class="clearfix">
            <table class="summary-panel" cellspacing="0">
                ...
                <tr class="total-row">
                    ...
                    <td class="value">{{ currency_format($grandTotal) }}</td>
                </tr>
                <tr>
    ...
    <div class="purchase-wrapper">
        ...
        <!-- Footer - Supplier Copy with Purchase Stamp -->
        <div class="footer-note clearfix">
            <div class="footer-left"><span class="disclaimer-text">Computer generated</span></div>
            @if ($footerLogoPath)
