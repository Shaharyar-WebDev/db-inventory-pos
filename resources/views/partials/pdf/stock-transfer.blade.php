...
<head>
    ...
    <style>
        ...
        /* ULTRA COMPACT - 2 transfers per page */
        body {
            margin: 0;
            padding: 0.2cm;
        ...
        /*-----------------------------------------------
            TRANSFER FLOW - 2 Column with Arrow
        -----------------------------------------------*/
        .transfer-flow {
            width: 100%;
...
<body>
            ...
            <tr>
                <td>
                    ...
                    <div class="outlet-detail">
                        ...
                        {{ $record->fromOutlet->address ?? 'Address not available' }}
                        @if ($record->fromOutlet->phone_number)
                            <br><strong>Tel:</strong> {{ $record->fromOutlet->phone_number }}
                        @endif
                    </div>
                </td>
                <td>
                    ...
                    <div class="outlet-detail">
                        ...
                        {{ $record->toOutlet->address ?? 'Address not available' }}
                        @if ($record->toOutlet->phone)
                            <br><strong>Tel:</strong> {{ $record->toOutlet->phone }}
                        @endif
                    </div>
                </td>
            </tr>
    ...
    <div class="transfer-wrapper">
        ...
        <!-- Footer - Destination Copy with Stamp -->
        <div class="footer-note clearfix">
            <div class="footer-left"><span class="disclaimer-text">Computer generated</span></div>
            @if ($footerLogoPath)
                <div class="footer-center"><img style="max-height: 0.7cm;" src="{{ $footerLogoPath }}" alt="Footer"></div>
